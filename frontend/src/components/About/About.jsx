...
const About = () => {
  ...
  const quote = "Small acts of kindness, when multiplied by millions of people, can transform the world.";
      ...
      if (data.success) {
        const options = {
          ...
          handler: async function (response) {
            try {
              const verificationResponse = await axios.post('/payment/donation-verification', {
